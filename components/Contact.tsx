    ...
    >
      <div className="max-w-4xl mx-auto">
        ...
        <motion.div
          ...
          className="bg-white dark:bg-gray-800 rounded-2xl p-8 md:p-12 border border-gray-200 dark:border-gray-700 shadow-lg"
        >
              ...
              <div className="flex flex-wrap gap-4">
                {aboutData.github && (
                  <motion.a
                    ...
                    className="p-3 rounded-lg bg-gray-100 dark:bg-gray-700 hover:bg-cyan-600 hover:text-white dark:hover:bg-cyan-600 transition-colors"
